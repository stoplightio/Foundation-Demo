...
*All of the notes, descriptions, and content fields in the Stoplight editors support use of [Stoplight Flavored Markdown](./2.stoplight-flavored-markdown.md). SMD supports more advanced features like themable callouts and embedded json schema models.*
