...
[I'm a URL link to the stoplight-flavored-markdown article](https://apiguild.stoplight.io/docs/foundation-demo/docs/Tutorial/Best%20Practices/1.stoplight-flavored-markdown.md#code-blocks)
