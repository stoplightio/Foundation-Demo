...
[I'm a relative link to the ./stoplight-flavored-markdown.md file](https://apiguild.stoplight.io/docs/foundation-demo/docs/Tutorial/Best%20Practices/1.stoplight-flavored-markdown.md#code-blocks)


<a href="1.stoplight-flavored-markdown.md" target="_blank">I also am a relative link to the ./stoplight-flavored-markdown.md file but will open in a new tab</a>
